...
| R010 | M1 | capacity condition | flat-compat global, reach λ=0 | same 128 train blocks | accuracy, repair, oracle gap, harm | MUST | BLOCKED_BY_R001 | task always writes metrics; 120 epochs |
| R011 | M1 | capacity condition | flat-compat global, reach λ=.1 | same 128 train blocks | accuracy, repair, oracle gap, harm | MUST | BLOCKED_BY_R001 | diagnostic default |
| R012 | M1 | capacity condition | flat-compat global, reach λ=.25 | same 128 train blocks | accuracy, repair, oracle gap, harm | MUST | BLOCKED_BY_R001 | safety trade-off |
| R013 | M1 | aggregate stage gate | at least one of R010–R012 | all three artifacts | aggregate pass/fail | MUST | BLOCKED_BY_R010_R012 | exit2 for missing/corrupt; exit1 for scientific negative |
