...
| R079 | M1 | split/outcome artifact materialization + independent audit | frozen Direct job10133585 + PROS feature writer | Phase-3 train identities → physically separate fit/checkpoint/falsifier | counts, overlap, native witness, hashes, record reconstruction | MUST | IMPLEMENTING_SYNTHETIC | Gate-0 GO permits code/tests only; fresh artifact-stage review required before execution |
